...
const PropertyForm = ({ property, onSave, onCancel }) => {
    ...
    useEffect(() => {
        if (property) {
            ...
            const typeObj = propertyTypes.find(
                (t) => t.value === propertyData.type
            );
            if (typeObj) {
        ...
        try {
            ...
            if (formData.fileReferences && formData.fileReferences.length > 0) {
                formData.fileReferences.forEach((fileRef) => {
                    propertyStorage.addFileReference(
                        savedProperty.id || formData.id,
                        fileRef
                    );
                });
            }
        ...
        <div className="form-step">
            ...
            <div className="form-row">
                <div className="form-group">
                    ...
                    />
                    {errors.landArea && (
                        <span className="error-message">{errors.landArea}</span>
                    )}
                </div>
                    ...
                    {amenityOptions.map((amenity) => (
                        <label key={amenity} className="checkbox-item">
                            <input
                                ...
                                onChange={() =>
                                    handleCheckboxChange(amenity, "amenities")
                                }
                            />
    ...
    const renderStep4 = () => (
        <div className="form-step">
            ...
            <div className="form-row">
                <div className="form-group">
                    <label htmlFor="registrationValue">
                        Registration Value (₹)
                    </label>
                    <input
                        type="number"
            ...
            <div className="form-row">
                <div className="form-group">
                    <label htmlFor="registrationFees">
                        Registration Fees (₹)
                    </label>
                    <input
                        type="number"
    ...
    const renderStep6 = () => (
        <div className="form-step">
            ...
            <div className="form-row">
                ...
                <div className="form-group">
                    <label htmlFor="subDivisionNumber">
                        Sub-division Number
                    </label>
                    <input
                        type="text"
            ...
            <div className="form-group">
                <label htmlFor="ownershipTitle">
                    Ownership Title (Record of Rights)
                </label>
                <textarea
                    id="ownershipTitle"
                    name="ownershipTitle"
                ...
                />
                <small className="help-text">
                    Latest Record of Rights (RoR) or mutation extract verifying
                    ownership
                </small>
            </div>

            <div className="form-group">
                <label htmlFor="encumbranceCertificate">
                ...
                />
                <small className="help-text">
                    Confirms the property is free from any legal dues,
                    mortgages, loans, or claims
                </small>
            </div>

            <div className="form-group">
                <label htmlFor="governmentApprovals">
                ...
                />
                <small className="help-text">
                    Zoning, land-use certificate, planning permissions (if any)
                </small>
            </div>
            ...
            <div className="form-group">
                ...
                />
                <small className="help-text">
                    Proof that property is not under dispute
                </small>
            </div>
            ...
            <div className="form-group">
                <label htmlFor="environmentalClearance">
    ...
    return (
        <div className="property-form-container">
            <div className="form-header">
                ...
                <p>
                    Complete all required information to add your property to
                    the system
                </p>
            </div>
            ...
            <div className="form-progress">
                ...
                <div className="step-labels">
                    <div className="step-label-grid">
                        ...
                        <span className={currentStep === 6 ? "active" : ""}>
                            Legal
                        </span>
                    </div>
                </div>
